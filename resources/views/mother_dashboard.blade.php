            ...
            <nav class="navbar navbar-expand-lg stroke">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mx-lg-auto">
                        ...
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="{{route('service.show',[Auth::guard('user')->user()->id])}}">Our Services</a>
                        </li>
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                        ...
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="{{route('contactus.show',[Auth::guard('user')->user()->id])}}">contact us</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown2" style="height: 150px; width: 200px; display: none;" id="dropdownContent">
                                <a class="dropdown-item" href="{{route('MProfile.show')}}"><i class="fa fa-user" aria-hidden="true"></i> Profile</a>
                                 <a class="dropdown-item" href="{{route('record.show',[Auth::guard('user')->user()->id])}}"><i class="fa fa-file" aria-hidden="true"></i> Medical Report</a>

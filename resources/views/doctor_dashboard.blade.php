    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="#" class="toggle-link"><i class="fa-solid fa-calendar-check"></i> Upcoming Appointments</a>
                <ul class="sublist">
                    <li><a href="pages/doctorAppointments/all_doc_appointment.html">All Appointments</a></li>
            ...
            <li><a href="#" class="toggle-link">  <i class="fa-solid fa-clipboard"></i> Medical Reports</a>
                <ul class="sublist">
                    <li><a href="pages/Medical_Reports/add_medical_report_form.html">Add Medical Report</a></li>
                    <li><a href="pages/Medical_Reports/all_medical_reports.html">All Medical Reports</a></li>
                    <li><a href="pages/Medical_Reports/medical_report_details.html">Medical Report Details</a></li>

                    <li><a href="pages/Medical_Reports/edit_medical_report.html">Edit Medical Report</a></li>
                </ul>
            </li>

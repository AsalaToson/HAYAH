            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg stroke">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- <img src="{{asset('site/assets/images/logo2.png')}}" alt=""> -->
                ...
                <div class="contact-left">
                    ...
                    <div class="cont-details">
                        ...
                        <div class="cont-top margin-up">
                            ...
                            <div class="cont-right">
                                <h6>Call Us</h6>
                                <p><a href="tel:(+02)123456">(+02) 123456</a></p>
                            </div>
                        </div>
                        <div class="cont-top margin-up">
                            <div class="cont-left text-center">
                            ...
                            <div class="cont-right">
                                <h6>Email Us</h6>
                                <p><a href="HAYAHA@gmail.com" class="mail">HAYAHA@gmail.com</a></p>
                            </div>
                        </div>
                        <div class="cont-top margin-up">
                            <div class="cont-left text-center">
                            ...
                            <div class="cont-right">
                                ...
                                <p><a href="HAYAHA support@gmail.com" class="mail">info@support.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="contact-right">
                    <form action="HAYAHA@gmail.com" method="post" class="signin-form">

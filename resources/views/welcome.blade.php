                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav mx-lg-auto">
                        ...
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="login/user">Our Services</a>

                        </li>
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">

                            <a class="nav-link scroll" href="login/user">pregnancy</a>
                        </li>
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="login/user">Baby</a>
                        </li>
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="login/user">Family</a>
                        </li>
                        <li class="nav-item  mr-lg-3 mt-lg-0 mt-3">
                            <a class="nav-link scroll" href="login/user">contact us</a>
                        </li>
                    ...
                    <div class="appointment-form">
                        <form action="#" method="post">
                            ...
                            <div class="appointment-btn text-lg-right">
                                <a href="login/user"><button type="submit" class="btn btn-style btn-primary mt-4">Book Appointment</button></a>
                            </div>
                        </form>
                    </div>
                </div>

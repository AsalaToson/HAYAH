...
<div class="main">
  ...
  <!-- sidebar-->
  <div class="sidebar">
    <a href="#"><img src="../../../../public/images/logo.png" alt="" width="200" height="100"></a>
    <ul>
      ...
      <li><a href="#" class="toggle-link"><i class="fas fa-medkit"></i> Analysis Requests</a>
        <ul class="sublist">
          <li><a href="all_requests.html">All  Requests</a></li>
      ...
      <li><a href="#" class="toggle-link">  <i class="fa-solid fa-clipboard"></i> Analysis Reports</a>
        <ul class="sublist">
          <li><a href="add_analysis_report.blade.php">Add Analysis Report</a></li>

          <li><a href="all_analysis_reports.blade.php">All Analysis Reports</a></li>
        </ul>
      </li>

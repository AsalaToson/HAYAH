    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">عدم تاكيد موعد المريض</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('AppointmentApproval.unapproval', $appointment->id) }}" method="post">
                    @method('GET')
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-success">{{ trans('Unapprove') }}</button>
                    </div>
                </form>
            </div>
        </div>

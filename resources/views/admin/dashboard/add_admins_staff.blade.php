...
@section('content')
    <div class="short" >
        <h3 class="dash"> Add Stuff</h3>
        <div class="top"> <i class="fa fa-home" ></i> <p  class="rout"> / Staff / Add Stuff </p></div>
    </div>
        <div class="inner_content">
            <h3>Add Stuff</h3><br>
            <hr>

            <form id="add-patient-form" action="{{route('admins.store')}}" method="post">
                @csrf
                <div class="form-group">
                    <label for="first-name"> Receptionist Name</label><br/>
                    <input type="text" id="first-name" name="name" required placeholder=" Receptionist Name">
                </div>
